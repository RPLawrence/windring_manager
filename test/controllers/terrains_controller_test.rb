...
class TerrainsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create terrain" do
    assert_difference('Terrain.count') do
      post terrains_url, params: { terrain: { Heightfield: @terrain.Heightfield, RegionUUID: @terrain.RegionUUID, Revision: @terrain.Revision } }
    end
  ...
  test "should update terrain" do
    patch terrain_url(@terrain), params: { terrain: { Heightfield: @terrain.Heightfield, RegionUUID: @terrain.RegionUUID, Revision: @terrain.Revision } }
