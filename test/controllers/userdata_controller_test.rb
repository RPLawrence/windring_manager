...
class UserdataControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create userdatum" do
    assert_difference('Userdatum.count') do
      post userdata_url, params: { userdatum: { DataKey: @userdatum.DataKey, DataVal: @userdatum.DataVal, TagId: @userdatum.TagId, UserId: @userdatum.UserId } }
    end
  ...
  test "should update userdatum" do
    patch userdatum_url(@userdatum), params: { userdatum: { DataKey: @userdatum.DataKey, DataVal: @userdatum.DataVal, TagId: @userdatum.TagId, UserId: @userdatum.UserId } }
