...
class AvatarsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create avatar" do
    assert_difference('Avatar.count') do
      post avatars_url, params: { avatar: { Name: @avatar.Name, PrincipalID: @avatar.PrincipalID, Value: @avatar.Value } }
    end
  ...
  test "should update avatar" do
    patch avatar_url(@avatar), params: { avatar: { Name: @avatar.Name, PrincipalID: @avatar.PrincipalID, Value: @avatar.Value } }
