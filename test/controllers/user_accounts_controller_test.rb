...
class UserAccountsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_account" do
    assert_difference('UserAccount.count') do
      post user_accounts_url, params: { user_account: { Created: @user_account.Created, Email: @user_account.Email, FirstName: @user_account.FirstName, LastName: @user_account.LastName, PrincipalID: @user_account.PrincipalID, ScopeID: @user_account.ScopeID, ServiceURLs: @user_account.ServiceURLs, UserFlags: @user_account.UserFlags, UserLevel: @user_account.UserLevel, UserTitle: @user_account.UserTitle, active: @user_account.active } }
    end
  ...
  test "should update user_account" do
    patch user_account_url(@user_account), params: { user_account: { Created: @user_account.Created, Email: @user_account.Email, FirstName: @user_account.FirstName, LastName: @user_account.LastName, PrincipalID: @user_account.PrincipalID, ScopeID: @user_account.ScopeID, ServiceURLs: @user_account.ServiceURLs, UserFlags: @user_account.UserFlags, UserLevel: @user_account.UserLevel, UserTitle: @user_account.UserTitle, active: @user_account.active } }
