...
class PresencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create presence" do
    assert_difference('Presence.count') do
      post presences_url, params: { presence: { LastSeen: @presence.LastSeen, RegionID: @presence.RegionID, SecureSessionID: @presence.SecureSessionID, SessionID: @presence.SessionID, UserID: @presence.UserID } }
    end
  ...
  test "should update presence" do
    patch presence_url(@presence), params: { presence: { LastSeen: @presence.LastSeen, RegionID: @presence.RegionID, SecureSessionID: @presence.SecureSessionID, SessionID: @presence.SessionID, UserID: @presence.UserID } }
