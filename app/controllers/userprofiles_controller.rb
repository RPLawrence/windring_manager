class UserprofilesController < ApplicationController
  ...
  private
    ...
    def userprofile_params
      params.require(:userprofile).permit(:profilePartner, :profileAllowPublish, :profileMaturePublish, :profileURL, :profileWantToMask, :profileWantToText, :profileSkillsMask, :profileSkillsText, :profileLanguages, :profileImage, :profileAboutText, :profileFirstImage, :profileFirstText)
    end
end
