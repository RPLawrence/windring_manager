class ClassifiedsController < ApplicationController
  ...
  private
    ...
    def classified_params
      params.require(:classified).permit(:creatoruuid, :creationdate, :expirationdate, :category, :name, :description, :parceluuid, :parentestate, :snapshotuuid, :simname, :posglobal, :parcelname, :classifiedflags, :priceforlisting)
    end
end
